...
def get_date_time_from_post(browser, post):
    try:
        ...
        status_link = WebDriverWait(post, 10).until(ec.presence_of_element_located((By.CSS_SELECTOR, "span[aria-labelledby][class='x1rg5ohu x6ikm8r x10wlt62 x16dsc37 xt0b8zv'], span[class='x1n2onr6 x1qiirwl'], span>a[aria-label][role='link'][tabindex='0']")))
        ...
        "div.__fb-dark-mode > div[style]:not([hidden]) > div > span[class='x193iq5w xeuugli x13faqbe x1vvkbs x1xmvt09 x1nxh6w3 x1sibtaa xo1l8bm xzsf02u'], \
        div.__fb-dark-mode > div[style]:not([hidden]) > div > span[class], \
        div.__fb-light-mode > div[style]:not([hidden]) > div > span[class='x193iq5w xeuugli x13faqbe x1vvkbs x1xmvt09 x1nxh6w3 x1sibtaa xo1l8bm xzsf02u'],\
        div.__fb-light-mode > div[style]:not([hidden]) > div > span[class]")))
